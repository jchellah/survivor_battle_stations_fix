...
public:
	...
	virtual const CBaseCombatCharacter *	SelectMoreDangerousThreat( const INextBot *me, 
															   ...
															   CBaseCombatCharacter *threat2 ) const;	// return the more dangerous of the two threats to 'subject', or NULL if we have no opinion
};
...
inline const CBaseCombatCharacter *IContextualQuery::SelectMoreDangerousThreat( const INextBot *me, const CBaseCombatCharacter *subject, CBaseCombatCharacter *threat1, CBaseCombatCharacter *threat2 ) const
{
	return NULL;
}
